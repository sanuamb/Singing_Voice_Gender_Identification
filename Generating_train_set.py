...
print(train_set)
audiofiles=list(train_set.iloc[:,0])
dt=train_set.set_index(['performance_id'])['gender'].to_dict()

count=0
features=[]
for key in dt:
    
    filename='/users/saniyaambavanekar/Documents/MLSP_Project/Train_set/'+key+'.wav'
...
df.to_csv('train_gender.csv', sep=',')
